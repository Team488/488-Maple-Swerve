...
public final class Crescendo2024FieldObjects {
    ...
    /** a simulated note on field has collision space, and can be "grabbed" by an intake simulation */
    ...
    private static final double FEED_SHOT_INITIAL_HEIGHT_METERS = 0.3,
    ...
    /** a feed-shot note has collision space */
    public static final class FeedShotHighNote extends GamePieceOnFlyDisplay {
        ...
        public FeedShotHighNote(
                Translation2d shooterPositionOnField,
                Translation2d targetedPositionOnField,
                CompetitionFieldSimulation simulation) {
            super(
    ...
    /** a feed-shot note has collision space */
    private static final double LOW_SHOT_NOTE_SPEED_MPS = 8,
